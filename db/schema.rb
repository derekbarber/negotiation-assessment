...
ActiveRecord::Schema.define(version: 20141001224238) do
  ...
  add_index "respondents", ["confirmation_token"], name: "index_respondents_on_confirmation_token", unique: true, using: :btree
  add_index "respondents", ["email"], name: "index_respondents_on_email", unique: true, using: :btree
  add_index "respondents", ["organization_id"], name: "index_respondents_on_organization_id", using: :btree
  add_index "respondents", ["reset_password_token"], name: "index_respondents_on_reset_password_token", unique: true, using: :btree
